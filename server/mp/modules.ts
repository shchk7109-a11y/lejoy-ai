...
export const MP_MODULES: MpModule[] = [
  ...
  { id: "story-time", name: "AI 故事会", icon: "📖", description: "给孙辈讲个专属的好故事", creditCost: 3, enabled: false, theme: { bg: "#DBEAFE", border: "#BFDBFE", title: "#1D4ED8" } },
  { id: "life-assistant", name: "生活助手", icon: "🌿", description: "识花、查菜谱、健康百科", creditCost: 1, enabled: false, theme: { bg: "#DCFCE7", border: "#BBF7D0", title: "#166534" } },
  ...
  { id: "ai-kaleidoscope", name: "AI 万花筒", icon: "🩺", description: "用AI解答你的问题", creditCost: 1, enabled: false, theme: { bg: "#FCE7F3", border: "#FBCFE8", title: "#9D174D" } },
];
