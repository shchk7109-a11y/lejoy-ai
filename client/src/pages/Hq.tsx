...
type Batch = { id: number; storeId: number; amount: number; quantity: number; expiresAt: string; purpose: "purchase" | "promotion"; receiptRef: string | null; status: "pending" | "active" | "revoked"; createdAt: string; inventory: Inventory };
...
export default function Hq() {
  ...
  const [batchForm, setBatchForm] = useState({ storeId: "", amount: "20", quantity: "10", expiresAt: "", purpose: "purchase" as "purchase" | "promotion", receiptRef: "" });
